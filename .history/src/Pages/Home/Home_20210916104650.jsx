  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          backgroundImage: "url(../assset/images/bg_5.jpg)",
          // backgroundImage: `url(${URL.createObjectURL(e)}`,
                ...
                <div className="row">
                  <div className="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
                    <div
                      ...
                      style={{ 
                        backgroundImage: "url(../../asset/images/services-1.jpg)" ,
                      // backgroundImage: `url(${URL.createObjectURL(e)}`,
                      // backgroundPosition: "center",
                      // backgroundSize: "cover",
                      // height: "200px",
                ...
                <div className="project-wrap">
                  ...
                  <div className="text p-4">
                    ...
                    <p className="location">
                      <span className="fa fa-map-marker"></span> Banaue, Ifugao,
                      Philippines
                    </p>
                    <ul>
                      <li>
