   ...
   <div class="container">
     ...
     <div class="collapse navbar-collapse" id="ftco-nav">
       <ul class="navbar-nav ml-auto">
         ...
         <li class="nav-item"><a href="/destiination" class="nav-link">Destination</a></li>
  ...
  <div class="container">
    ...
    <div class="col-md-6">
     <div class="row">
      ...
      <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
        <div class="services services-1 color-3 d-block img" style={{
      ...
      <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
        <div class="services services-1 color-4 d-block img" style={{
          backgroundImage: "url('images/services-4.jpg')"
        }}
        >
   ...
   <div class="col-md-12 about-intro">
    <div class="row">
     <div class="col-md-6 d-flex align-items-stretch">
      <div class="img d-flex w-100 align-items-center justify-content-center" style={{
...
<section class="ftco-section testimony-section bg-bottom" style={{
          backgroundImage: "url('images/bg_1.jpg')"
        }}
>
 <div class="overlay"></div>
...
<footer class="ftco-footer bg-bottom ftco-no-pt" style={{
